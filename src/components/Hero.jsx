...
const Hero = () => {
  return (
    <div className="min-h-screen bg-[#1A2641] flex items-center justify-center py-[6rem] md:py-[7vw] px-4">
      <div className="my-container w-full max-w-7xl mx-auto">
        {/* Main Hero Card */}
        <div className="bg-[#FFFFFF] rounded-3xl p-6 md:p-12 relative overflow-hidden">
          ...
          <div className="text-center space-y-6">
            ...
            {/* Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#1A2641] tracking-tight leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 w-full sm:w-auto">
              <button className="w-full sm:w-auto bg-[#F4B942] hover:bg-[#E5A832] text-[#1A2641] font-semibold px-8 py-3 rounded-lg shadow-md transition-all duration-200 hover:shadow-lg">
                SUBMIT A COMPLAINT
              </button>
              <button className="w-full sm:w-auto bg-[#2A3B5C] hover:bg-[#3A4B6C] text-white font-semibold px-8 py-3 rounded-lg shadow-md transition-all duration-200 hover:shadow-lg">
                TRACK STATUS
              </button>
            </div>
          </div>
